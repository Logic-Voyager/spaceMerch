...
<body>
  ...
  <h2>🧠 Inspiration</h2>
  <p>The universe is full of wonder—and so is learning to build in a time crunch. As a physics student passionate about space, I created <strong>Enigma</strong> to combine my interest in astronomy with web development during this hackathon.</p>
  ...
  <ul>
    ...
    <li>🧠 Cart functionality using React state</li>
    <li>💬 Feedback/contact form via Netlify Forms</li>
    ...
    <li>Responsive product listings with cart functionality</li>
    <li>Search and filter by category</li>
    <li>Netlify deployment with CI/CD</li>
    <li>Netlify Forms for user contact</li>
  </ul>
